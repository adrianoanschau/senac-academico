...
const NAV_ITEMS: NavItemProps[] = [
  {
    ...
    label: 'Dashboard',
    icon: LayoutGrid,
    activeClass: 'bg-slate-800 text-white shadow-md shadow-slate-800/30',
    inactiveClass: 'text-slate-400 hover:text-slate-800 hover:bg-slate-800/10',
    end: true,
  },
  {
    to: '/schedule',
    label: 'Cronograma',
    icon: CalendarClock,
    activeClass: 'bg-senac-blue text-white shadow-md shadow-senac-blue/30',
    inactiveClass:
      'text-slate-300 hover:text-senac-blue hover:bg-senac-blue/10',
  },
  {
    to: '/class-groups',
    label: 'Turmas',
    icon: Layers,
    activeClass: 'bg-menu-turmas text-white shadow-md shadow-menu-turmas/30',
    inactiveClass:
      'text-slate-300 hover:text-menu-turmas hover:bg-menu-turmas/10',
  },
  {
    to: '/courses',
    label: 'Cursos',
    icon: GraduationCap,
    activeClass: 'bg-menu-cursos text-white shadow-md shadow-menu-cursos/30',
    inactiveClass:
      'text-slate-300 hover:text-menu-cursos hover:bg-menu-cursos/10',
  },
  {
    to: '/subjects',
    label: 'Dicionário de UCs',
    icon: BookOpen,
    activeClass: 'bg-menu-uc text-white shadow-md shadow-menu-uc/30',
    inactiveClass: 'text-slate-300 hover:text-menu-uc hover:bg-menu-uc/10',
  },
  {
    to: '/curriculums',
    label: 'Matriz Curricular',
    icon: Library,
    activeClass: 'bg-menu-matriz text-white shadow-md shadow-menu-matriz/30',
    inactiveClass:
      'text-slate-300 hover:text-menu-matriz hover:bg-menu-matriz/10',
  },
  {
    to: '/professors',
    label: 'Professores',
    icon: Users,
    activeClass:
      'bg-menu-professores text-white shadow-md shadow-menu-professores/30',
    inactiveClass:
      'text-slate-300 hover:text-menu-professores hover:bg-menu-professores/10',
  },
  {
    to: '/rooms',
    label: 'Salas e Ambientes',
    icon: MapPin,
    activeClass: 'bg-menu-salas text-white shadow-md shadow-menu-salas/30',
    inactiveClass:
      'text-slate-300 hover:text-menu-salas hover:bg-menu-salas/10',
  },
  {
    to: '/calendar-reserves',
    label: 'Períodos Especiais',
    icon: CalendarDays,
    activeClass:
      'bg-menu-especiais text-white shadow-md shadow-menu-especiais/30',
    inactiveClass:
      'text-slate-300 hover:text-menu-especiais hover:bg-menu-especiais/10',
  },
];
      ...
      <button
        ...
        className={`group relative flex justify-center items-center h-12 w-12 rounded-2xl mx-auto transition-all duration-200 ${
          isOpen
            ...
            : 'text-slate-400 hover:text-slate-800 hover:bg-slate-800/10'
        }`}
      >
    ...
    <aside className="w-24 bg-white flex flex-col items-center h-screen shrink-0 shadow-[4px_0_24px_rgb(0,0,0,0.02)] z-20 overflow-visible">
      ...
      <div className="shrink-0 flex flex-col items-center gap-6 w-full px-6 pb-8 pt-4">
        ...
        <button
          ...
          className="group relative flex items-center justify-center h-12 w-12 rounded-2xl text-slate-300 hover:text-menu-especiais hover:bg-menu-especiais/10 transition-colors mx-auto"
        >
          <LogOut size={24} />
          <div className="absolute left-full ml-3 px-3 py-2 bg-white text-slate-700 text-sm font-semibold rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 delay-150 group-hover:delay-0 whitespace-nowrap shadow-lg border border-slate-100 z-50 pointer-events-none flex items-center">
            Sair
