  ...
  return (
    <div className="w-full max-w-6xl mx-auto pb-10">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Gerencie períodos especiais (sobrescrita do padrão de dias letivos e
            não letivos).
          </p>
        </div>
      ...
      <div className="bg-white rounded-4xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.03)] border border-slate-100 relative overflow-hidden">
        <LoadingOverlay visible={isLoading} message="Buscando períodos..." />
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              {filteredFeriados.length === 0 && !isLoading && (
                <tr>
                  <td
                    colSpan={5}
                    className="py-8 text-center text-slate-500 font-medium"
                  >
                    Nenhum período especial encontrado.
                  </td>
                </tr>
              )}
              {filteredFeriados.map((feriado) => (
                ...
                >
                  ...
                  <td className="py-4 px-4 font-bold text-menu-especiais">
                    {new Date(feriado.startTime).toLocaleString()}
                  </td>
                  <td className="py-4 px-4 font-bold text-menu-especiais">
                    {new Date(feriado.endTime).toLocaleString()}
                  </td>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-4xl p-8 w-full max-w-md shadow-[0_8px_30px_rgb(0,0,0,0.12)] relative overflow-hidden">
            ...
            <LoadingOverlay visible={isSaving} message="Salvando período..." />
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-[#f8f9fc] border-none rounded-xl focus:ring-2 focus:ring-menu-especiais outline-none transition-all text-slate-800"
              ...
              <div>
                ...
                <Select
                  ...
                  onChange={handleInputChange}
                  required
                  className="w-full px-4 py-3 bg-[#f8f9fc] border-none rounded-xl focus:ring-2 focus:ring-menu-especiais outline-none transition-all text-slate-800 cursor-pointer"
                >
                  <option value="BLOCK">Período Não Letivo / Feriado</option>
                  <option value="EXTRA_DAY">
              ...
              <div className="mt-4 flex justify-end gap-3">
                ...
                <button
                  type="submit"
                  className="bg-menu-especiais hover:opacity-90 text-white px-5 py-2.5 rounded-xl font-bold transition-colors shadow-md shadow-menu-especiais/30"
                >
                  Salvar
                </button>
              </div>
