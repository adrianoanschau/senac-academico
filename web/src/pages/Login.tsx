      ...
      <div className="hidden lg:flex lg:w-1/2 bg-senac-blue relative overflow-hidden flex-col justify-center items-center p-12 transition-colors">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <h1 className="text-5xl font-bold text-white mb-6 leading-tight">
            ...
            <br />
            com o{' '}
            <span className="text-senac-orange transition-colors">Senac.</span>
          </h1>
          <p className="text-xl text-blue-100 font-medium leading-relaxed">
            Acesse a plataforma para acompanhar turmas, alunos e potencializar a
            rotina acadêmica.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 sm:p-12">
        <div className="w-full max-w-md bg-white rounded-4xl p-8 sm:p-12 shadow-[0_8px_30px_rgb(0,0,0,0.03)] border border-slate-100">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-6">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <Link
                  to="/forgot-password"
                  className="text-sm text-senac-blue hover:opacity-80 font-semibold transition-colors"
                >
                  Esqueceu a senha?
                </Link>
              </div>
          ...
          <div className="relative flex items-center my-8">
            ...
            <span className="shrink mx-4 text-xs font-bold text-slate-400 uppercase">
              Ou
            </span>
            <div className="grow border-t border-slate-200"></div>
          </div>
          ...
          >
            {isGoogleLoading ? (
              ...
              >
                <path
                  d="M17.6402 9.20455C17.6402 8.56648 17.5811 7.95227 17.4684 7.36364H9V10.8409H13.8443C13.6366 11.9727 13.0002 12.9375 12.0457 13.5227V15.8182H14.9561C16.6582 14.2557 17.6402 11.9318 17.6402 9.20455Z"
                  fill="#4285F4"
                />
                <path
                  d="M9.00001 18C11.4307 18 13.4688 17.1932 14.9561 15.8182L12.0457 13.5227C11.2389 14.0818 10.2134 14.4318 9.00001 14.4318C6.60001 14.4318 4.62274 12.8409 3.96138 10.75H0.854553V13.125C2.43751 16.0966 5.48183 18 9.00001 18Z"
                  fill="#34A853"
                />
                <path
                  d="M3.96138 10.75C3.7841 10.25 3.67728 9.71023 3.67728 9.15909C3.67728 8.60795 3.7841 8.06818 3.96138 7.56818V5.19318H0.854553C0.306826 6.22727 0 7.64205 0 9.15909C0 10.6761 0.306826 12.0909 0.854553 13.125L3.96138 10.75Z"
                  fill="#FBBC05"
                />
                <path
                  d="M9.00001 3.88636C10.3205 3.88636 11.5079 4.34091 12.4182 5.19886L15.0273 2.58523C13.4636 1.09659 11.4261 0 9.00001 0C5.48183 0 2.43751 2.90341 0.854553 5.19318L3.96138 7.56818C4.62274 5.47727 6.60001 3.88636 9.00001 3.88636Z"
                  fill="#EA4335"
                />
              </svg>
            )}
            <span>
              {isGoogleLoading ? 'Aguardando...' : 'Entrar com Google'}
            </span>
          </button>
          ...
          <div className="mt-10 text-center text-sm font-medium text-slate-400">
            <p>
              Precisa de ajuda?{' '}
              <a
                href="mailto:aanschau@senacrs.com.br"
