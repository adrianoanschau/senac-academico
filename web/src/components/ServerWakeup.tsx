...
export const ServerWakeup: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => {
      ...
      return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-slate-50 p-4 text-center">
          ...
          <p className="text-slate-500 max-w-md">
            A nossa API está hospedada em um serviço que entra em hibernação por
            inatividade. Isso pode levar cerca de 1 minuto. Por favor, aguarde,
            a aplicação carregará automaticamente em breve.
          </p>
        </div>
      );
    }
