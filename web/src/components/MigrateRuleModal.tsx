...
export const MigrateRuleModal: React.FC<MigrateRuleModalProps> = ({
  isOpen,
  onClose,
  ruleId,
  initialDate,
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      const transitionDateIso = new Date(
        `${data.transitionDate}T12:00:00`,
      ).toISOString();
          ...
          <div className="p-6 flex flex-col gap-5">
            <div className="bg-amber-50 border-l-4 border-amber-500 p-4 text-amber-800 text-sm mb-2 flex items-start gap-3 rounded-r-lg">
              ...
              <p className="leading-relaxed">
                As aulas já realizadas ou agendadas antes da data de transição
                serão mantidas no histórico. O saldo de horas será recalculado e
                projetado no novo padrão.
              </p>
            </div>
