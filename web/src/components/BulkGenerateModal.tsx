...
export const BulkGenerateModal: React.FC<BulkGenerateModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center z-50 p-4 transition-opacity">
      <div className="bg-white rounded-4xl w-full max-w-4xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] flex flex-col max-h-[95vh] overflow-hidden relative">
        <LoadingOverlay
        ...
        >
                ...
                <div>
                  ...
                  {errors.daysOfWeek && (
                    <span className="text-xs text-rose-500 font-bold mt-2 block">
                      Selecione pelo menos um dia letivo para a grade.
                    </span>
                  )}
                </div>
              </>
          ...
          <div className="p-8 py-6 shrink-0 bg-white border-t border-slate-100 flex justify-end gap-3 rounded-b-4xl">
            ...
            <button
              ...
              className="bg-[#004a8d] hover:bg-[#00386b] text-white px-5 py-2.5 rounded-xl font-bold transition-colors shadow-[0_4px_14px_rgb(0,74,141,0.3)] disabled:opacity-70 flex items-center gap-2"
            >
              {isSubmitting ? (
                <>
